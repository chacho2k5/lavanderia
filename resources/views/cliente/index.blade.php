                        ...
                        <table id="table" class="table pt-1 table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">{{ $cliente->cuil }}</td>
                                    <td scope="col">{{ $cliente->telefono1 }}</td>
                                </tr>
                                @endforeach --}}
                            </tbody>
                        </table>
                ...
                "buttons":[
                    {
                        ...
                        className: 'btnCliente text-white btn-sm rounded opacity-75'
                    },
                    // {
                    //     extend: 'spacer',
                    //     style: '',
